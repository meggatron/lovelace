...
def draw_cards():
    ...
    y_position = (screen_height - object_height) // 2

    root.geometry(f"{object_width}x{object_height}+{x_position}+{y_position}")
